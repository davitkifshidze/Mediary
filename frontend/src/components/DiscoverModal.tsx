...
export function DiscoverModal({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      {/* ⚠️ **სიმაღლე ფიქსირებულია და ეს განზრახაა** (შენი მითითება,
          2026-09-14). `DialogContent`-ს მხოლოდ `max-h` აქვს, ე.ი. სიმაღლეს
          შიგთავსი წყვეტდა: ჩატვირთვისას ერთი ხაზი („იტვირთება…") იდგა და
          მოდალი დაბალი იყო, ბადის მოსვლაზე კი მკვეთრად ხტებოდა.
          ⚠️ „საბოლოო ზომის" გამოთვლა **არ გამოდგებოდა** — რიგების რაოდენობა
          `per_page`-ზეა დამოკიდებული (პარამეტრია), ე.ი. ხტუნვა დარჩებოდა. */}
