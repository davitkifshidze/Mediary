 ...
 * დავასრულე" თარიღი აქვს** (`goal_modules` სერვერიდან). წიგნს, თამაშს,
 * სამაგიდოსა და ჩანაწერს ის არ აქვს — და `updated_at`-ით ჩანაცვლება
 * ზუსტად ის იქნებოდა, რასაც FEAT-08 თავიდან იცილებს (ერთ სვეტში ორი
 * ფაქტი). სიაში ისინი ამიტომ არ ჩანან, და ეს რედაქტორში წერია.
 *
  ...
  const editor = editing && (
    <ModalShell title={t('goals.title', { year: data.year })} onClose={() => setEditing(false)}>
      <div className="space-y-4">
        ...
        {/* ⚠️ რატომ აკლია მოდულები — კითხვა თვითონ ჩნდება, ე.ი. პასუხიც აქვე უნდა ეწეროს */}
