...
| SEC-13 | ცოცხალ ბაზაში `user` როლს (ე.ი. ყოველ ჩვეულებრივ ანგარიშს) ოთხივე ადმინ-სექცია აქვს მინიჭებული (GAP-10-ის შესრულებისას ნაპოვნი) | High | security | S | ⬜ |
...
- **სტატუსი:** ⬜ ღია — **კოდის ხარვეზი არაა, ეს მონაცემია**: გასწორება ბაზის ცვლილებაა, ე.ი. შენი გადაწყვეტილება (იხ. „გადაწყვეტა").
- **ტიპი:** security
...
- **Acceptance criteria:**
  - [ ] `user` როლის `permissions`-ში `admin:*` გასაღები არ არის (ან ცხადად დადასტურებულია, რომ განზრახაა)
  - [ ] გადაწყვეტილება ჩაწერილია: `nato_medic`-ს ადმინ-წვდომა უნდა ჰქონდეს თუ არა (თუ კი — **ცალკე როლით** და არა `user`-ით, რომელსაც ყოველი ახალი ანგარიში იღებს)
- **Estimate:** S
- **დამოკიდებულება:** none
