...
⚠️ **დარჩენილი სამი კოდის მიღმაა და ამიტომ ვერ სრულდება აქედან:** ორი **შენი ქმედებაა** (SEC-01 — პაროლები და Telegram-ის ტოკენი; SEC-06 — TMDB-ის გასაღების როტაცია), ერთი კი `hunspell (ka_GE)`-ს ჩამოტვირთვას ელოდება (DEBT-26) — ეს ამ მანქანაზე დაყენებული არ არის და **ბინარის ჩამოტვირთვა-გაშვება შენი ცხადი ნებართვის გარეშე არ კეთდება**. ყველა `path:line` რეპოს root-იდანაა და აუდიტის მომენტს ასახავს.
