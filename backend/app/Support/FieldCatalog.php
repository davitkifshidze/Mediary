...
final class FieldCatalog
{
    ...
    private const MEDIA_FIELDS = [
        ...
        /* FEAT-18 — პირადი ტეგები. ⚠️ **ჟანრის შემდეგ არ დგას განზრახ**:
           ჟანრი TMDB-ის გაზიარებული ლექსიკონია და სინქრონი მას წერს, ტეგი
           კი მხოლოდ ჩემია — ერთმანეთის გვერდით ისინი ერთ ღერძად წაიკითხებოდა. */
